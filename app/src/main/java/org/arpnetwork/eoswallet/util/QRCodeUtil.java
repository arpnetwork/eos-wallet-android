 ...
 * @Author Wangnan
 * @Date 2017/2/7
 * @refer https://github.com/sinawangnan7/QRCodeDemo/tree/master/lib/src/main/java/com/example/lib/QRCodeUtil
 * @refer https://www.jianshu.com/p/b275e818de6a
 */
...
public class QRCodeUtil {
    ...
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size) {
        return createQRCodeBitmap(content, size, "UTF-8", ErrorCorrectionLevel.H, 0, Color.BLACK, Color.WHITE, null, null, 0F);
    }
    ...
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size, @ColorInt int color_black, @ColorInt int color_white) {
        return createQRCodeBitmap(content, size, "UTF-8", ErrorCorrectionLevel.H, 0, color_black, color_white, null, null, 0F);
    }
    ...
    public static Bitmap createQRCodeBitmap(String content, int size, @Nullable Bitmap logoBitmap, float logoPercent) {
        return createQRCodeBitmap(content, size, "UTF-8", ErrorCorrectionLevel.H, 0, Color.BLACK, Color.WHITE, null, logoBitmap, logoPercent);
    }
    ...
    public static Bitmap createQRCodeBitmap(String content, int size, Bitmap targetBitmap) {
        return createQRCodeBitmap(content, size, "UTF-8", ErrorCorrectionLevel.H, 0, Color.BLACK, Color.WHITE, targetBitmap, null, 0F);
    }
    ...
    @Nullable
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size,
            @Nullable String character_set, @Nullable ErrorCorrectionLevel error_correction, @Nullable int margin,
